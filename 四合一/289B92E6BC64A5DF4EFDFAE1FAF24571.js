function t(p) {
    ...
    function y() {
        ...
        tt || (tt = !0, m($ ? i : u), n.request({
            ...
            method: "GET",
            success: function(n) {
                200 == +n.statusCode && n.data && n.data.data.connectUrl ? I(Q.socketUrl = n.data.data.connectUrl) : t(n);
            },
            fail: t,
            complete: function() {
                return tt = !1;
    ...
    function k() {
        d() ? _("connect") : O() && (_("reconnect"), X()), m(s), w(), j();
    }
    function v(t) {
        M(t.data);
    }
    ...
    this.serviceUrl = p, this.socketUrl = null, this.status = null, this.open = y, this.on = function(t, n) {
        ...
        return Q.status === c;
    }, this.isConnecting = d, this.isActive = R, this.isReconnecting = O, m(c);
...
var n = require("30989775BC64A5DF56FEFF7261E24571.js"), e = require("70480E26BC64A5DF162E662145134571.js"), o = null, c = t.STATUS_CLOSED = "CLOSED", i = t.STATUS_CONNECTING = "CONNECTING", s = t.STATUS_ACTIVE = "ACTIVE", u = t.STATUS_RECONNECTING = "RECONNECTING", r = t.ERR_CONNECT_SERVICE = 1001, a = (t.ERR_CONNECT_SOCKET = 1002, 
